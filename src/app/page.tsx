                            ...
                            {cities.map(city => (
                                <div key={city.name} className="absolute" style={{ left: city.x, top: city.y, transform: 'translate(-50%, -50%)' }}>
                                    <div className="relative group">
                                        ...
                                        <div className="absolute top-0 left-0 w-3 h-3 bg-primary rounded-full border-2 border-primary-foreground"></div>
                                        <div className="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 w-max bg-card text-card-foreground p-2 rounded-lg text-sm shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
