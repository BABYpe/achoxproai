...
import { Loader, Wand2, DollarSign, FileText } from 'lucide-react'
            ...
            <div className="grid md:grid-cols-2 gap-8 items-start">
                <Card className="shadow-xl rounded-2xl">
                    <CardHeader>
                        ...
                        <CardDescription>أدخل تفاصيل مشروعك للحصول على تقدير دقيق للتكلفة بناءً على أسعار السوق الحالية.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="space-y-2">
                                <Label htmlFor="location">موقع المشروع</Label>
                                <Input id="location" name="location" placeholder="مثال: الرياض، المملكة العربية السعودية" defaultValue="Riyadh" />
                            </div>
                            <div className="space-y-2">
                ...
                <div className="flex flex-col gap-8">
                    ...
                    <Card className="w-full shadow-xl rounded-2xl">
                        <CardHeader>
                             ...
                             <CardDescription>تفصيل التكاليف المقدرة للمشروع.</CardDescription>
                        </CardHeader>
                        <CardContent>
                             {isLoading ? (
                                ...
                                <div className="space-y-4 text-sm">
                                    <div className="flex justify-between items-center bg-secondary/50 p-2 rounded-md">
                                        ...
                                        <span className="font-mono text-primary font-semibold">{result.breakdown.materials}</span>
                                    </div>
                                    <div className="flex justify-between items-center bg-secondary/50 p-2 rounded-md">
                                        <span className="font-semibold">العمالة:</span>
                                        <span className="font-mono text-primary font-semibold">{result.breakdown.labor}</span>
                                    </div>
                                    <div className="flex justify-between items-center bg-secondary/50 p-2 rounded-md">
                                        <span className="font-semibold">التراخيص والرسوم:</span>
                                        <span className="font-mono text-primary font-semibold">{result.breakdown.permits}</span>
                                    </div>
                                    <div className="flex justify-between items-center bg-secondary/50 p-2 rounded-md">
                                        <span className="font-semibold">تكاليف أخرى:</span>
                                        <span className="font-mono text-primary font-semibold">{result.breakdown.other}</span>
                                    </div>
                                </div>
                             ) : (
                                <div className="text-center text-muted-foreground py-10">
                                    <FileText className="h-10 w-10 mx-auto mb-2" />
                                    <p>ستظهر تفاصيل التكلفة هنا بعد الحساب.</p>
                                </div>
                             )}
                        </CardContent>
                    </Card>
